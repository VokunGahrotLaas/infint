...
int main(void)
{
	...
	std::cout << std::endl << "/!\\ End /!\\, press entrer to continue... ";
	std::cin.get();
	return EXIT_SUCCESS;
}
...
void exemple_rsa(void)
{
	...
	if (p == 0)
		...
		do
		{
			p = rand();
			if (!p.get(0)) ++p;
		} while (!InfIntMath::probable_prime(p));
	...
	if (q == 0)
		...
		do
		{
			q = rand();
			if (!q.get(0)) ++q;
		} while (!InfIntMath::probable_prime(q));
	...
	std::cout << "End Exemple RSA, press entrer to continue... ";
	std::cin.get();
...
void exemple_random(void)
{
	...
	std::cout << "End Exemple Random, press entrer to continue... ";
	std::cin.get();
	std::cout << std::endl << std::endl << std::endl;
}
...
void exemple_prime(void)
{
	...
	std::cout << "End Exemple Prime, press entrer to continue... ";
	std::cin.get();
	std::cout << std::endl << std::endl << std::endl;
}
...
void exemple_text(void)
{
	...
	std::cout << "End Exemple Text, press entrer to continue... ";
	std::cin.get();
	std::cout << std::endl << std::endl << std::endl;
}
...
void exemple_ratio(void)
{
	...
	std::cout << "End Exemple Ratio, press entrer to continue... ";
	std::cin.get();
	std::cout << std::endl << std::endl << std::endl;
}
	...
	for (int i = min; i < max; ++i)
		for (int j = min; j < max; ++j)
			if ((InfInt(i) + InfInt(j)).to_int_safe<int>() != i + j)
				std::cout << "bug: " << i << " + " << j << " = " << i + j
						  << " or getting: " << (InfInt(i) + InfInt(j)).to_int_safe<int>() << std::endl;
	...
	for (int i = min; i < max; ++i)
	{
		for (int j = min; j < max; ++j)
		{
			...
			if (result.remainder().to_int_safe<int>() != i % j)
				std::cout << "bug: " << i << " % " << j << " = " << i % j
						  << " or getting: " << result.remainder().to_int_safe<int>() << std::endl;
			if (result.quotient().to_int_safe<int>() != i / j)
				std::cout << "bug: " << i << " / " << j << " = " << i / j
						  << " or getting: " << result.quotient().to_int_safe<int>() << std::endl;
		}
	}
	std::cout << "Finished testing fulldiv" << std::endl << std::endl;

	std::cout << "End Operators' Tests, press entrer to continue... ";
	std::cin.get();
	std::cout << std::endl << std::endl << std::endl;
}
